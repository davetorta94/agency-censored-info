    ...
    <>
        <div className="container-fluid intro pb-4 introduccion" ref={ref}>
            ...
            >
              ...
              animate={introControls}
              transition={{ duration: 1.5, delay: 1}}>
                {/*<div className="col-lg-4 mb-2 d-flex justify-content-center text-white">
                    <h2 className="jaja">A TU ALCANCE</h2>
                </div>*/}
...
//<div className="col-lg-4 mb-2 d-flex justify-content-center text-white alcance">
//                    <h2>A TU ALCANCE</h2>
//                </div>
